...
export default function ShareCard({
  ...
  // LinkedIn share text — proud, professional tone
    ...
    <div className="space-y-5">
      ...
      <div className={`p-5 rounded-2xl border ${scoreBg}`}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-white font-medium">{positiveFrame}</p>
            {topActions && (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-[#0A66C2]/10 border border-[#0A66C2]/30 text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-colors font-medium"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-colors font-medium"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-[#1877F2]/10 border border-[#1877F2]/30 text-[#1877F2] hover:bg-[#1877F2]/20 transition-colors font-medium"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
